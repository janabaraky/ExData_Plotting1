PLOT1
power<- read.table("household_power_consumption",skip=1,sep =";")
...
hist(as.numeric(as.character(subpower$Global_active_power)),col="red",main="Global Active Power",xlab ="Global Active Power(kilometers)")
